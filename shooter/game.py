...
jump_fx = pygame.mixer.Sound('shooter/audio/jump.wav')
jump_fx.set_volume(0.05)
shot_fx = pygame.mixer.Sound('shooter/audio/shot.wav')
shot_fx.set_volume(0.05)
grenade_fx = pygame.mixer.Sound('shooter/audio/grenade.wav')
grenade_fx.set_volume(0.05)

#load images
#button images
start_img = pygame.image.load('shooter/img/start_btn.png').convert_alpha()
exit_img = pygame.image.load('shooter/img/exit_btn.png').convert_alpha()
restart_img = pygame.image.load('shooter/img/restart_btn.png').convert_alpha()
#background
...
for x in range(TILE_TYPES):
	...
	img_list.append(img)
#bullet
bullet_img = pygame.image.load('shooter/img/icons/bullet.png').convert_alpha()
#grenade
grenade_img = pygame.image.load('shooter/img/icons/grenade.png').convert_alpha()
#pick up boxes
health_box_img = pygame.image.load('shooter/img/icons/health_box.png').convert_alpha()
ammo_box_img = pygame.image.load('shooter/img/icons/ammo_box.png').convert_alpha()
	...
	def __init__(self, char_type, x, y, scale, speed, ammo, grenades):
		...
		for animation in animation_types:
			...
			for i in range(num_of_frames):
				img = pygame.image.load(f'shooter/img/{self.char_type}/{animation}/{i}.png').convert_alpha()
